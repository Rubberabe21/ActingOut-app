...
ASSETS.COFFEE.src = 'assets/caffe.png';
ASSETS.BOOST.src = 'assets/boost.png';
ASSETS.SHIELD.src = 'assets/scudo.png';
ASSETS.LAG.src = 'assets/lag.png';
ASSETS.JAM.src = 'assets/jam.png';

ASSETS["BRIEF CONFUSO"].src = 'assets/brief.png';
ASSETS["FEEDBACK EXTRA"].src = 'assets/feedback.png';
ASSETS["LOGO PIÙ GRANDE"].src = 'assets/logo.png';
ASSETS["SCADENZA IERI"].src = 'assets/scadenza.png';
ASSETS["RENDER CRASH"].src = 'assets/render.png';
ASSETS["FATTURA SCADUTA"].src = 'assets/fattura.png';
ASSETS["CALL ALLE 18"].src = 'assets/call.png';
ASSETS["BUDGET ZERO"].src = 'assets/budget.png';
ASSETS["MICRO-MANAGEMENT"].src = 'assets/micromanagement.png';

ASSETS["PROMPT ERRORE"].src = 'assets/prompt.png';
ASSETS["METEO AVVERSO"].src = 'assets/meteo.png';
ASSETS["OVERTIME NOTTURNO"].src = 'assets/overnight.png';
ASSETS["NOTIFICA SLACK"].src = 'assets/notifiche.png';
ASSETS["FINAL_V2_DEF.PDF"].src = 'assets/pdf.png';
ASSETS["PREVENTIVO BASSISSIMO"].src = 'assets/preventivo.png';

ASSETS.BOSS_1.src = 'assets/boss1.png';
ASSETS.BOSS_2.src = 'assets/boss2.png';
ASSETS.BOSS_3.src = 'assets/boss3.png';
ASSETS.BOSS_4.src = 'assets/boss4.png';
ASSETS.BOSS_5.src = 'assets/boss5.png';

const imgCover = new Image(); imgCover.src = 'assets/copertina.png';

const imgTommi = new Image(); imgTommi.src = 'assets/tommi.png';
const imgGiampa = new Image(); imgGiampa.src = 'assets/giampa.png';
const imgBretto = new Image(); imgBretto.src = 'assets/bretto.png';

const astTommi = new Image(); astTommi.src = 'assets/tommi-ast.png';
const astGiampa = new Image(); astGiampa.src = 'assets/giampa-ast.png';
const astBretto = new Image(); astBretto.src = 'assets/bretto-ast.png';
...
function update() {
  ...
  if (state === 'dead') {
    ...
    if (deathTimer <= 0) {
      state = 'gameover';
      saveScore(score);
      ArcadeGameShell.showEndActions({ onRetry: () => { state = 'CHAR_SELECT'; }, onExit: () => exitGame(score) });
    }
    return;
  }
